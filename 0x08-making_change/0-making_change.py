...
def makeChange(coins, total):
    ...
    Returns:
    int: Fewest number of coins needed to reach the total, or -1 if it cannot be done.
    """
    if total <= 0:
        return 0
    ...
    for coin in coins:
        ...
        total -= num_coins * coin  # Reduce the total by the value of used coins

    # If after all this, the total isn't 0, it means we couldn't match the exact total
    if total != 0:
        return -1
